...
Excersizes with vectors

1. Create the following vectors: `r print(c(1,1,3,4,5))` and `r print(c(2, 2, 5, 4, 1))` 
...
7. find out which element of vector on e is in vector 2. 
...
Excersizes with regular expressions
